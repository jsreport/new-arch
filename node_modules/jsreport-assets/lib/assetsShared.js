...
module.exports.linkPath = (reporter, definition, link) => {
...
module.exports.readFile = async (reporter, definition, link) => {
...
module.exports.readAsset = async (reporter, definition, id, name, encoding, req) => {
