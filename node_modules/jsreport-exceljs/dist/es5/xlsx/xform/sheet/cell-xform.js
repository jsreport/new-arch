...
function (_BaseXform) {
  ...
  _createClass(CellXform, [{
    ...
    value: function prepare(model, options) {
      var cellStylesCache = options.cellStylesCache;
      var modelStyle = model.style || {};
      var modelStyleKey = JSON.stringify(modelStyle);
      ...
      if (!model.styleId) {
        var styleId = options.styles.addStyleModel(modelStyle, getEffectiveCellType(model));
