...
function () {
  function WorksheetWriter(options) {
    ...
    this._merges = []; // keep record of all formulas
  ...
  _createClass(WorksheetWriter, [{
    ...
    value: function commit() {
      ...
      this.rawColsXML = this._writeColumns(true); // we _cannot_ accept new rows from now on
    ...
    key: "_writeColumns",
    value: function _writeColumns(getXML) {
      if (!getXML) {
        ...
        if (model.cells) {
          model.cells.forEach(function (cell) {
            if (cell.formula != null) {
              _this2._calcCells[cell.address] = true;
            }
          });
        }
    ...
    get: function get() {
      if (!this._stream) {
        // eslint-disable-next-line no-underscore-dangle
        this._stream = this._workbook._openStream("/xl/worksheets/sheet".concat(this.id, ".xml"), this.id); // pause stream to prevent 'data' events
