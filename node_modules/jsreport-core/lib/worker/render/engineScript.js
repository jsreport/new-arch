...
module.exports = function (inputs, callback, done) {
  ...
  const originalEngine = inputs.engine.execute
  ...
  try {
    if (templateHelpers) {
      ...
      if (typeof templateHelpers === 'string' || templateHelpers instanceof String) {
        const initialItemsInSandbox = Object.keys(sandboxContext)
    ...
    run('respond(null, render(m.template.content, { require })(m.template.helpers, m.data))', {
