...
class MainReporter extends Reporter {
  ...
  async render (req, parentReq) {
    ...
    this.#requestsMap.set(req.context.requestId, req)
    ...
    try {
      responseResult = await this.scriptManager.execute({
        ...
        callback: async (data) => {
          const req = this.#requestsMap.get(data.requestId)
          const result = await this.#callbackActions(data, req)
          return result
        }
      })
      ...
      this.#requestsMap.delete(req.context.requestId)
    }
