...
const ScriptManager = require('../../lib/main/scriptsManager')
const engine = require('../../lib/worker/render/executeEngine')
const safeSandboxPath = path.join(__dirname, '../../lib/worker/render/safeSandbox')

describe('engine', () => {
  describe('engine with worker-threads strategy', () => {
    const scriptManager = new ScriptManager({ strategy: 'worker-threads' })
  ...
  describe('engine with http-server strategy', () => {
    const scriptManager = new ScriptManager({ strategy: 'http-server' })
  ...
  describe('engine with dedicated-process strategy', () => {
    const scriptManager = new ScriptManager({ strategy: 'dedicated-process' })
  ...
  describe('engine with in-process strategy', function () {
    const scriptManager = new ScriptManager({ strategy: 'in-process' })
