...
module.exports = (reporter, definition) => {
  ...
  reporter.beforeRenderListeners.insert({ after: 'data' }, 'pdf-utils', async (req, res) => {
    ...
    function pdfFormField (el) {
      ...
      return `<span style='display: inline-block;vertical-align:middle;text-transform:none;font-size:1.1px;width: ${el.width}px; height: ${el.height}px'>form@@@${value}@@@</span>`
    }
